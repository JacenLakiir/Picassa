...
public class CeilParenExpression extends ParenExpression
{
    ...
    {
        return new CeilParenExpression(operands);
    }
    ...
    public RGBColor evaluate ()
    {
        ...
        return ColorTransformations.ceiling(color);
    }
    ...
    private CeilParenExpression ()
    {}

    protected static ExpressionFactory getParenFactory ()
    {
        return new ExpressionFactory(new CeilParenExpression());
    }
